...
-- }
--
function justalocker.handle_inventory(name, def, original_def)
	...
	if lockable then
		...
		justalocker.register(locked_name, locked_def)
		minetest.register_craft({
			type = "shapeless",
			output = "justalocker:" .. locked_name,
			recipe = { "justalocker:" .. name, "default:steel_ingot" }
		})
	end
